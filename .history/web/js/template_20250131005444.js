class webheader extends HTMLElement {
    connectedCallback(){
        ...
        this.innerHTML = `
            <header>
                <button style="all:unset; width: 18%; cursor:pointer;" onclick="window.location.href='login.html'">    
                    <img src="images/logo.png" style="width:100%;height:auto;">
                </button>
                <div class="headersection">
                    <button class="headerbutton" onclick="window.location.href='help/login.html'">Help</button>
                    <button class="headerbutton" onclick="window.location.href='account/auth/signup/login.html'">Signup</button>
